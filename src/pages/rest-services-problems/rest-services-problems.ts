...
@IonicPage()
@Component({
  selector: 'page-rest-services-problems',
  templateUrl: 'rest-services-problems.html',
})
export class RestServicesProblemsPage {

  isSoapSelected: boolean = false;
  amountOfDays = 6;
  config;
  response;
  data: any[] = [];
  ...
  getRestErrors() {
    this.rest.findRestServicesProblems(this.amountOfDays, this.config).subscribe(
